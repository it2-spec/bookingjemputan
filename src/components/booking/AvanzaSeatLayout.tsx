...
export function AvanzaSeatLayout({ seats, onSeatClick }: AvanzaSeatLayoutProps) {
  ...
  return (
    ...
    >
      {/* Vehicle outline */}
      <div className="relative bg-surface-50 dark:bg-surface-800/50 border-2 border-surface-200 dark:border-surface-700 rounded-3xl p-5 pt-7 pb-8 w-[240px]">
        {/* Windshield */}
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-32 h-6 bg-primary-100 dark:bg-primary-900/40 border-2 border-surface-200 dark:border-surface-700 rounded-t-2xl flex items-center justify-center">
